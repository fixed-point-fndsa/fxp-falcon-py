...
inv_q_x  = from_float_mantissa(_sage_const_1p0  / Q, M_INV_Q)
...
inv_sigma_x_by_n = {n: from_float_mantissa(_sage_const_1p0  / s, M_INV_SIGMA)
                    for n, (s, _) in FALCON_PARAMS.items()}
