...
# NB: FFT loads need no dedicated rule — fft_fxp's contract (m_out = m_in +
# log2(n), the n=2 base case paying the Pythagorean sqrt2) is total, so the
# tight coefficient bound IS the right load tag (see fft_fxp module docstring).
